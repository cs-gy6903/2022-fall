...
blue = httpx.get("https://shattered.io/static/shattered-1.pdf").content
red = httpx.get("https://shattered.io/static/shattered-2.pdf").content
...
def problem3() -> SHAttered:
    ...
    * compute hash by downloading the pdfs (e.g. with requests library)
    ...
    """
    return {
        "blue_pdf_sha1": problem1(blue),
        "blue_pdf_sha256": problem2(blue),
        "red_pdf_sha1": problem1(red),
        "red_pdf_sha256": problem2(red),
    }
